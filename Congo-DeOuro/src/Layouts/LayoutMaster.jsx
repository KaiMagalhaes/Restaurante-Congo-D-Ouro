      ...
      <nav className="navbar navbar-expand-lg navbar-custom">
        <div className="container-fluid">
          ...
          <div className="navbar-nav ms-auto">
            ...
            {cargo === "admin" && (
              <Link className="nav-link nav-link-custom" to="/gerente">
                Gerência
              </Link>
            )}

            {cargo === "chef" && (
              <Link className="nav-link nav-link-custom" to="/cozinha">
                Cozinha
              </Link>
            )}

            {cargo ? (
              <button onClick={sair} className="btn btn-link nav-link-custom">
                Sair
              </button>
            ) : (
